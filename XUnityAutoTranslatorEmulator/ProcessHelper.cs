...
namespace XUnityAutoTranslatorEmulator
{
    ...
    public class ProcessHelper
    {
        ...
        public ProcessHelper(string path)
        {
            _path = path;
        }

        public async Task<int> Start(string? workingDirectory = null, bool redirect = true, bool trackProcess = true)
        {
            ...
            void OutputDataReceived(object sender, DataReceivedEventArgs data)
            {
                if (string.IsNullOrEmpty(data.Data)) return;
                Output.OnNext((StreamType.Output, data.Data));
            }

            void ErrorEventHandler(object sender, DataReceivedEventArgs data)
            {
                if (string.IsNullOrEmpty(data.Data)) return;
